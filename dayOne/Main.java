public class Main {
            ...
            for (int j = 0; j < intArray.length; j++) {
                if (intArray[i] != intArray[j]) {
                    if (intArray[i] + intArray[j] == 2020) {
                        ...
                        solution = intArray[i] * intArray[j];
                        firstNumber = intArray[i];
                        secondNumber = intArray[j];
    ...
    public static void solutionTwo (Integer[] intArray){
        int solution = 0;
        int firstNumber = 0;
        int secondNumber = 0;
        int thirdNumber = 0;
            ...
            for (int j = 0; j < intArray.length; j++) {
                for (int k = 0; k < intArray.length; k++) {
                    if (intArray[i] + intArray[j] + intArray[k] == 2020) {
                        solution = intArray[i] * intArray[j] * intArray[k];
                        firstNumber = intArray[i];
                        secondNumber = intArray[j];
                        thirdNumber = intArray[k];
                        break;
    ...
    public static Integer[] convertToArray(String numList){

        String numListArray[] = numList.split(" ");

        Integer[] intArray = new Integer[numListArray.length];
        int q = 0;
        for (String str : numListArray) {
            intArray[q] = Integer.parseInt(str);//Exception in this line
            q++;
        }
